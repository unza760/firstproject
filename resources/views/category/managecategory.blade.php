                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-flex align-items-center justify-content-between">
                                <h4 class="mb-0 font-size-18 ml-5">Create Product</h4>
                                <a href="{{ url('/add/category') }}" class="btn btn-outline-primary btn-sm">Add Category</a>  
...
<div class="col-md-9 col-md-offset-3  mt-5 p-3 ml-5">
